  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Bienvenido a la página de inicio de Mi Tienda Online." />
      </Helmet>
      <div className="pageContent">
        <section className={styles.hero}>
          <h2 className="heading-2">Bienvenido a Mi Tienda Online</h2>
        ...
        <section className={styles.featuredCategories}>
          <Link to="/search?category=smartphones" className={styles.categoryCard} title="Ver productos de esta categoría">
            ...
            <h3 className="heading-3">Tecnología</h3>
          </Link>
          <Link to="/search?category=mens-shirts" className={styles.categoryCard} title="Ver productos de esta categoría">
            ...
            <h3 className="heading-3">Moda</h3>
          </Link>
          <Link to="/search?category=furniture" className={styles.categoryCard} title="Ver productos de esta categoría">
            ...
            <h3 className="heading-3">Hogar</h3>
          </Link>
          <Link to="/search?category=groceries" className={styles.categoryCard} title="Ver productos de esta categoría">
            ...
            <h3 className="heading-3">Comestibles</h3>
          </Link>
        </section>
        ...
        <section className={styles.banners}>
          <div className={styles.banner}>
            ...
            <h3 className="heading-3">Ofertas de Temporada</h3>
            <p className="paragraph">¡No te pierdas nuestras increíbles ofertas de temporada! Descuentos de hasta el 50% en productos
              seleccionados.</p>
            <Link to="/search?mode=news" className="btn btn-primary">Ver Ofertas</Link>
          </div>
          <div className={styles.banner}>
            <img src={newProducts} alt="Nuevos productos" />
            <h3 className="heading-3">Nuevos Productos</h3>
            <p className="paragraph">Descubre las últimas novedades en nuestro catálogo. ¡Productos innovadores que te encantarán!</p>
